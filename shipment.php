                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body-store">
                                        <div class="chart-area-store">
                                            ...
                                            $total_pengiriman_query = mysqli_query($mysqli, "SELECT COUNT(smf.ShipMethodID) as total FROM shipping_fact smf");
                                            $total_row = mysqli_fetch_array($total_pengiriman_query);
                                            $total_pengiriman = $total_row['total'];
                                            ...
                                            while ($row = mysqli_fetch_array($shipment)) {
                                                ...
                                                // Hitung persentase
                                                $persentase[] = ($row['total'] / $total_pengiriman) * 100;
                                            }
                                            ?>
                ...
                tooltips: {
                    callbacks: {
                        label: function(tooltipItem, data) {
                            ...
                            var percentage = <?php echo json_encode($persentase); ?>[tooltipItem.index];
