                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Total Pembelian Produk berdasarkan
                                        Category</h6>
                                </div>
                                <!-- Card Body -->
...
var ctx = document.getElementById('myBarChart').getContext('2d');
            ...
            xAxes: [{
                ...
                plugins: {
                    ...
                    title: {
                        display: true,
                        text: 'Top 5 Produk Jarang Dibeli'
                    }
                }
            }
        });
