...
<body id="page-top">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col auto">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Total
                                                kuantitas barang yang dibeli pada Tahun 2004</div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col auto">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Rata-rata Order Produk per Customer</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col auto">
                                            <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">Total
                                                Order berdasarkan kategori Road Bikes</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-900">
                                                <?php
                                                $mysqli = mysqli_connect("localhost", "root", "", "tugasakhirdwo");
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Perbandingan Jumlah Order di Tahun
                                        2002-2004</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Trend Jumlah Kuantitas Produk Setiap
                                        Tahun</h6>
                                </div>
                                <div class="card-body">
                                    <div class="chart-area">
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Top 5 Total Order Berdasarkan Category</h6>
                                </div>
                                <div class="card-body">
                                    <div class="chart-bar">
    ...
    <script type="text/javascript">
        ...
        $mysqli = mysqli_connect("localhost", "root", "", "tugasakhirdwo");
        $query = "SELECT p.NameSub as category, SUM(sf.orderqty) as total 
            FROM sales_fact sf 
